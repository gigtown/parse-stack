...
Gem::Specification.new do |spec|
  ...
  spec.required_ruby_version = ">= 4.0.1", "< 5.0"

  spec.add_runtime_dependency "activemodel", [">= 5", "<= 8.1.2"]
  spec.add_runtime_dependency "active_model_serializers", [">= 0.9", "< 1"]
  spec.add_runtime_dependency "activesupport", [">= 5", "<= 8.1.2"]
  spec.add_runtime_dependency "parallel", [">= 1.6", "< 2"]
  spec.add_runtime_dependency "faraday", ">= 0.17.0", "< 3.0"
